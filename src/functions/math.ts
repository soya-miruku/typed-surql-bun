...
export function fixed(value: number, precision: number) {
...
export function interquartile(array: Array<number>) {
...
export function midhinge(array: Array<number>) {
...
export function mode(array: Array<number>) {
  return qlFn.create(`math::mode([${array}])`)
}

export function nearestrank(array: Array<number>, number: number) {
  return qlFn.create(`math::nearestrank([${array}], ${number})`)
}

export function percentile(array: Array<number>, number: number) {
  return qlFn.create(`math::percentile([${array}], ${number})`)
}

export function product(array: Array<number>) {
...
export function spread(array: Array<number>) {
...
export function stddev(array: Array<number>) {
...
export function top(array: Array<number>, number: number) {
  return qlFn.create(`math::top([${array}], ${number})`)
}

export function trimean(array: Array<number>) {
  return qlFn.create(`math::trimean([${array}])`)
}

export function variance(array: Array<number>) {
